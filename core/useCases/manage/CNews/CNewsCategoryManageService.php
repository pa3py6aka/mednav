...
class CNewsCategoryManageService
{
    private $repository;
    private $transaction;

    public function __construct(CNewsCategoryRepository $repository, TransactionManager $transaction)
    {
        $this->repository = $repository;
        $this->transaction = $transaction;
    }

    public function create(CNewsCategoryForm $form): CNewsCategory
    {
        $category = CNewsCategory::create
        (
            $form->name,
            $form->contextName,
            $form->enabled,
    ...
    public function edit($id, CNewsCategoryForm $form): void
    {
