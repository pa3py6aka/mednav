...
$this->registerJsVar('_ImageUploadAction', Url::to(['/news/news/upload']));
...
<div class="company-form box box-primary">
    ...
    <div class="box-body table-responsive">
        ...
        <?= $form->field($model, 'categoryId')->dropDownList(\core\forms\manage\CategoryForm::parentCategoriesList(NewsCategory::class)) ?>
