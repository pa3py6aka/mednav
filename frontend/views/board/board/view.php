            ...
            <div class="col-md-12">
                <?php if ($board->isArchive()): ?>
                    ...
                    <div class="alert alert-warning">
                        <noindex>Автор данного объявления его давно не обновлял, возможно оно потеряло актуальность.</noindex>
                    </div>
                <?php endif; ?>
                <div class="do-item-vendor-block">
                    <div class="do-item-vendor-text">
                        <ul>
                            ...
                            <?= HtmlHelper::infosetListItem('Факс:', $board->author->isCompany() && $board->author->isCompanyActive() ? $board->author->company->fax : '', $board->author->isCompany() && $board->author->isCompanyActive() && $board->author->company->fax) ?>
