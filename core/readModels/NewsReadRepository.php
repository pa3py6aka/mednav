...
class NewsReadRepository
{
    ...
    public function getAllBy(NewsCategory $category = null, $companyId = null): DataProviderInterface
    {
        $query = News::find()->alias('a')->active('a')->with('mainPhoto');
    ...
    private function getProvider(ActiveQuery $query, $default = null): ActiveDataProvider
    {
        $provider = new ActiveDataProvider([
            ...
            'pagination' => [
                'pageSizeLimit' => [1, 250],
                'defaultPageSize' => !$default ? \Yii::$app->settings->get(SettingsManager::NEWS_PAGE_SIZE) : $default,
