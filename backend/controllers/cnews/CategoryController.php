...
use core\forms\manage\CNews\CNewsCategoryForm;
use core\useCases\manage\CNews\CNewsCategoryManageService;
use Yii;
use yii\base\Module;
...
class CategoryController extends Controller
{
    ...
    public function __construct($id, Module $module, CNewsCategoryManageService $service, array $config = [])
    {
    ...
    public function actions()
    {
        return [
            'tree-manage' => [
                ...
                'entityClass' => CNewsCategory::class,
                'url' => '/cnews/category',
            ],
        ];
    }
    ...
    public function actionIndex()
    {
        $dataProvider = new ActiveDataProvider([
            'query' => CNewsCategory::find()->roots(),
    ...
    public function actionUpdate($id)
    {
        ...
        $form = new CNewsCategoryForm($category);
    ...
    {
        if (($model = CNewsCategory::findOne($id)) !== null) {
            return $model;
        } else {
