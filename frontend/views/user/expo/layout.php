...
$this->title = 'Личный кабинет | ' . Yii::$app->settings->get(\core\components\SettingsManager::EXPO_NAME_UP);
...
<div class="row">
    ...
    <div class="col-md-9">
        <?= \frontend\widgets\AccountBreadcrumbs::show([Yii::$app->settings->get(\core\components\SettingsManager::EXPO_NAME_UP)]) ?>
        <h1><?= Yii::$app->settings->get(\core\components\SettingsManager::EXPO_NAME_UP) ?></h1>
