...
class BrandReadRepository
{
    ...
    public function getAllBy(BrandCategory $category = null, $companyId = null): DataProviderInterface
    {
        $query = Brand::find()->alias('a')->active('a')->with('mainPhoto');
    ...
    private function getProvider(ActiveQuery $query, $default = null): ActiveDataProvider
    {
        $provider = new ActiveDataProvider([
            ...
            'pagination' => [
                'pageSizeLimit' => [1, 250],
                'defaultPageSize' => !$default ? \Yii::$app->settings->get(SettingsManager::BRANDS_PAGE_SIZE) : $default,
