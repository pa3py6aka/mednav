    ...
    <div class="panel-body">
        <ul class="nav nav-pills nav-stacked">
            ...
            <?php if ($user->isCompany()): ?>
                ...
                <li role="presentation"<?= $controller == 'user/article' ? ' class="active"' : '' ?>><a href="<?= Url::to(['/user/article/active']) ?>"><?= Yii::$app->settings->get(\core\components\SettingsManager::ARTICLE_NAME_UP) ?></a></li>
            <?php endif; ?>
