...
$this->title = Yii::$app->settings->get(\core\components\Settings::TRADE_NAME_UP) . ' | Редактирование товара';
...
<div class="row">
    ...
    <div class="col-md-9">
        <?= \frontend\widgets\AccountBreadcrumbs::show([['label' => Yii::$app->settings->get(\core\components\Settings::TRADE_NAME_UP), 'url' => ['/user/trade/active']], 'Редактирование товара']) ?>
